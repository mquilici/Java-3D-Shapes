...
/**
 * http://math.hws.edu/graphicsbook/source/jogl/Polyhedron.java
...
public class Shapes {
    ...
    public Shapes(double[][] vertices, int[][] faces, double[][] normals) {
        this(vertices,faces,null,normals);
    }
   
    public Shapes(double[][] vertices, int[][] faces, double[][] faceColors, double[][] normals) {
    ...
    public static Shapes cube = new Shapes( 
        new double[][] {
    ...
    public static Shapes dodecahedron = new Shapes( 
        new double[][] {
    ...
    public static Shapes icosahedron = new Shapes( 
        new double[][] {
    ...
    public static Shapes octahedron = new Shapes( 
        new double[][] {
          {-1.000000,0.000000,0.000000},
          {0.000000,0.000000,-1.000000},
          {0.000000,0.000000,1.000000},
    ...
    public static Shapes socerBall = new Shapes( 
        new double[][] {
    ...
    public static Shapes stellatedDodecahedron = new Shapes( 
        new double[][] {
    ...
    public static Shapes stellatedIcosahedron = new Shapes( 
        new double[][] {
    ...
    public static Shapes stellatedOctahedron = new Shapes( 
        new double[][] {
    ...
    public static Shapes truncatedIcosahedron = new Shapes( 
        new double[][] {
    ...
    public static Shapes truncatedRhombicDodecahedron = new Shapes( 
        new double[][] {
